...
export default function PostCard({ post, featured = false }) {
  ...
  if (featured) {
    return (
      <a
        href={href}
        className="group block bg-[#080808] border border-white/[0.07] rounded-2xl mb-6 hover:border-white/[0.14] hover:bg-[#0a0a0a] hover:shadow-[0_0_30px_-10px_rgba(14,165,233,0.08)] transition-all duration-300 overflow-hidden"
      >
        <div className="flex flex-col sm:flex-row">
          ...
          {post.thumbnail ? (
            <div className="sm:w-72 lg:w-96 shrink-0 sm:border-l border-t sm:border-t-0 border-white/[0.07] overflow-hidden relative">
            ...
            <div className="sm:w-72 lg:w-96 shrink-0 sm:border-l border-t sm:border-t-0 border-white/[0.07] bg-gradient-to-br from-[#0ea5e9]/10 to-[#0c4a6e]/20 flex items-center justify-center relative overflow-hidden">
  ...
  return (
    <a
      href={href}
      className="group flex flex-col bg-[#080808] border border-white/[0.07] rounded-xl overflow-hidden hover:border-white/[0.15] hover:bg-[#0a0a0a] hover:shadow-[0_0_25px_-12px_rgba(14,165,233,0.06)] hover:-translate-y-0.5 transition-all duration-300"
    >
